...
> 狀態：MVP 階段一～三已實作完成（2026-06-13）。本文件為企畫書正本。
> 追加（2026-06-13）：依 NES Tennis（1984）基準升級——兩段式發球（拋球時機）、掛網判定、
> 殺球（SMASH）、高吊球（LOB）實裝、LEVEL 1–5 難度、AI 上網戰術、可選局數（3/6）、
> 裁判椅與球員動畫、雙打線球場視覺、標題 BGM。
